            ...
            <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
                <div class="col-span-4 lg:text-center lg:pt-14 mb-10">
                    ...
                    <p class="mt-4 block text-gray-400 text-xs">
                        Published
                        <time>{{ $article->created_at->format('j. M. Y, H:i:s') }}</time>
                    </p>
                ...
                <div class="col-span-8">
                    ...
                    <h1 class="font-bold text-3xl lg:text-4xl mb-10">{{ $article->title }}</h1>
                    <div class="space-y-4 lg:text-lg leading-loose">{!! $article->body !!}</div>
                </div>
                <section class="col-span-8 col-start-5 mt-10 space-y-6">
                    @include('articles._add-comment-form')
